...
import com.porkerspicks.ggs.domain.BetfairIdentifier;
import com.porkerspicks.ggs.domain.HorseSelection;
import com.porkerspicks.ggs.domain.Session;
import com.porkerspicks.ggs.exceptions.HorseSelectionException;
import com.porkerspicks.ggs.repository.BetRepository;
...
import com.porkerspicks.ggs.service.BetServiceImpl;
...
public class BetPlacingEngine {
...

	{
		...
		horseSelection.setSelection("Ashky");
		horseSelection.setUol(3.8);
		horseSelection.setStartTime(13,30);
		horseSelections.add( horseSelection );
		horseSelection = new HorseSelection();
		horseSelection.setSelection("Shut Up And Dance");
		horseSelection.setUol(2.46);
		horseSelection.setStartTime(13,40);
		horseSelections.add( horseSelection );
		horseSelection = new HorseSelection();
