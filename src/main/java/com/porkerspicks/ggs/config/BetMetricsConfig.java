package com.porkerspicks.ggs.config;
...
public class BetMetricsConfig {
	...
	public Counter createdBetCounter(MeterRegistry registry) {
		return Counter.builder("com.porkerspicks.ggs.bet.created").description("Number of Bets Created")
				.tags("environment", "production").register(registry);
	}

	@Bean
	public Counter http400ExceptionCounter(MeterRegistry registry) {
		return Counter.builder("com.porkerspicks.ggs.exceptions.HTTP400").description(
	...
	public Counter http404ExceptionCounter(MeterRegistry registry) {
		return Counter.builder("com.porkerspicks.ggs.exceptions.HTTP404").description(
