package com.porkerspicks.horses.aspects;
...
public class RestControllerAspect {
	...
	@Before("execution(public * com.porkerspicks.horses.web.*Controller.*(..))")
	public void generalAllMethodASpect() {
		logger.info("All Method Calls invoke this general aspect method");

	}

	@AfterReturning("execution(public * com.porkerspicks.horses.web.*Controller.addBet(..))")
